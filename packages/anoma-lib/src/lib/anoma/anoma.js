...
export class Account {
    ...
    * @returns {any}
    */
    static init(secret, token, epoch, fee_amount, gas_limit, tx_code, vp_code) {
        try {
            ...
            var ptr2 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            var len2 = WASM_VECTOR_LEN;
            var ptr3 = passArray8ToWasm0(vp_code, wasm.__wbindgen_malloc);
            var len3 = WASM_VECTOR_LEN;
            wasm.account_init(retptr, ptr0, len0, ptr1, len1, epoch, fee_amount, gas_limit, ptr2, len2, ptr3, len3);
...
export class Keypair {
    ...
    */
    to_bytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keypair_to_bytes(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var v0 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_free(r0, r1 * 1);
...
export class Mnemonic {
    ...
    */
    static new(size) {
        var ret = wasm.mnemonic_new(size);
    ...
    */
    static from_phrase(phrase) {
        ...
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.mnemonic_from_phrase(ptr0, len0);
        return Mnemonic.__wrap(ret);
    }
    /**
    ...
    */
    to_encrypted(password) {
        try {
            ...
            var len0 = WASM_VECTOR_LEN;
            wasm.mnemonic_to_encrypted(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    * @returns {Mnemonic}
    */
    static from_encrypted(encrypted, password) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passArray8ToWasm0(encrypted, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            wasm.mnemonic_from_encrypted(retptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class Transfer {
    ...
    * @returns {any}
    */
    static new(secret, encoded_source, encoded_target, token, amount, epoch, fee_amount, gas_limit, tx_code) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passStringToWasm0(encoded_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            var ptr2 = passStringToWasm0(encoded_target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len2 = WASM_VECTOR_LEN;
            var ptr3 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len3 = WASM_VECTOR_LEN;
            var ptr4 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            var len4 = WASM_VECTOR_LEN;
            wasm.transfer_new(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, amount, epoch, fee_amount, gas_limit, ptr4, len4);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
