    ...
    */
    static init(secret, token, epoch, fee_amount, gas_limit, tx_code, vp_code) {
        try {
            ...
            const ptr2 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passArray8ToWasm0(vp_code, wasm.__wbindgen_malloc);
...
export class IbcTransfer {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_ibctransfer_free(ptr);
    }
    /**
    * @param {string} secret
    * @param {string} sender
    ...
    * @returns {any}
    */
    static new(secret, sender, receiver, token, amount, epoch, fee_amount, gas_limit, source_port, source_channel, tx_code) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            const len3 = WASM_VECTOR_LEN;
            const ptr4 = passStringToWasm0(source_port, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len4 = WASM_VECTOR_LEN;
            const ptr5 = passStringToWasm0(source_channel, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len5 = WASM_VECTOR_LEN;
            const ptr6 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            const len6 = WASM_VECTOR_LEN;
            wasm.ibctransfer_new(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, amount, epoch, fee_amount, gas_limit, ptr4, len4, ptr5, len5, ptr6, len6);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class Keypair {
    ...
    */
    from_pointer_to_js_value() {
        const ret = wasm.keypair_from_pointer_to_js_value(this.ptr);
...
export class Transfer {
    ...
    */
    static new(secret, encoded_source, encoded_target, token, amount, epoch, fee_amount, gas_limit, tx_code) {
        try {
            ...
            const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(encoded_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(encoded_target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ptr3 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len3 = WASM_VECTOR_LEN;
            const ptr4 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            const len4 = WASM_VECTOR_LEN;
    ...
    * @returns {any}
    */
    static new_shielded(secret, encoded_source, encoded_target, token, amount, epoch, fee_amount, gas_limit, tx_code, shielded_transaction) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(secret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            const ptr4 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            const len4 = WASM_VECTOR_LEN;
            const ptr5 = passArray8ToWasm0(shielded_transaction, wasm.__wbindgen_malloc);
            const len5 = WASM_VECTOR_LEN;
            wasm.transfer_new_shielded(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, amount, epoch, fee_amount, gas_limit, ptr4, len4, ptr5, len5);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
function getImports() {
    ...
    imports.wbg.__wbg_getUTCDate_05b01f2eb0d59767 = function(arg0) {
