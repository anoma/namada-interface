...
* @returns {any}
*/
  static new(secret: string, sender: string, receiver: string, token: string, amount: number, epoch: number, fee_amount: number, gas_limit: number, source_port: string, source_channel: string, tx_code: Uint8Array): any;
}
/**
*/
...
* @param {number} gas_limit
* @param {Uint8Array} tx_code
* @param {Uint8Array} shielded_transaction
* @returns {any}
*/
  static new_shielded(secret: string, encoded_source: string, encoded_target: string, token: string, amount: number, epoch: number, fee_amount: number, gas_limit: number, tx_code: Uint8Array, shielded_transaction: Uint8Array): any;
}
/**
*/
export class Tx {
...
export interface InitOutput {
  ...
  readonly transfer_new_shielded: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number) => void;
  ...
  readonly __wbg_ibctransfer_free: (a: number) => void;
  readonly ibctransfer_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number) => void;
