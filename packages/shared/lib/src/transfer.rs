...
impl Transfer {
    ...
    pub fn new(
        ...
        let TransferMsg { source, target, token, amount, key, shielded } = msg;
...
mod tests {
    ...
    fn can_generate_transfer() {
        ...
        let amount = 1000;
        let msg = TransferMsg { source, target, token, amount, key: None, shielded: None };
