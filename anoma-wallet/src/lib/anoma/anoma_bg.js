import * as wasm from './anoma_bg.wasm';
...
* @returns {string}
*/
export function generate_mnemonic(size) {
    try {
...
export class Account {
    ...
    * @returns {any}
    */
    static init(serialized_keypair, token, epoch, fee_amount, gas_limit, tx_code, vp_code) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            var len1 = WASM_VECTOR_LEN;
            var ptr2 = passArray8ToWasm0(vp_code, wasm.__wbindgen_malloc);
            var len2 = WASM_VECTOR_LEN;
            wasm.account_init(retptr, addHeapObject(serialized_keypair), ptr0, len0, epoch, fee_amount, gas_limit, ptr1, len1, ptr2, len2);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export class DerivedAccount {
    ...
    static __wrap(ptr) {
        const obj = Object.create(DerivedAccount.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_derivedaccount_free(ptr);
    }
}
/**
*/
export class ExtendedKeys {
    ...
    static __wrap(ptr) {
        const obj = Object.create(ExtendedKeys.prototype);
        obj.ptr = ptr;
...
export class Keypair {
    ...
    * @returns {any}
    */
    from_pointer_to_js_value() {
        var ret = wasm.keypair_from_pointer_to_js_value(this.ptr);
    ...
    * @returns {Keypair}
    */
    static from_js_value_to_pointer(js_data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keypair_from_js_value_to_pointer(retptr, addHeapObject(js_data));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    encrypt_with_password(password) {
        try {
            ...
            var len0 = WASM_VECTOR_LEN;
            wasm.keypair_encrypt_with_password(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
    ...
    */
    static decrypt_with_password(encrypted_key_pair_data, password) {
        var ptr0 = passArray8ToWasm0(encrypted_key_pair_data, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ret = wasm.keypair_decrypt_with_password(ptr0, len0, ptr1, len1);
    ...
    */
    to_bytes() {
        try {
            const ptr = this.__destroy_into_raw();
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.keypair_to_bytes(retptr, ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export class Transfer {
    ...
    * @returns {any}
    */
    static new(serialized_keypair, encoded_source, encoded_target, token, amount, epoch, fee_amount, gas_limit, tx_code) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(encoded_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passStringToWasm0(encoded_target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            var ptr2 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len2 = WASM_VECTOR_LEN;
            var ptr3 = passArray8ToWasm0(tx_code, wasm.__wbindgen_malloc);
            var len3 = WASM_VECTOR_LEN;
            wasm.transfer_new(retptr, addHeapObject(serialized_keypair), ptr0, len0, ptr1, len1, ptr2, len2, amount, epoch, fee_amount, gas_limit, ptr3, len3);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export class Wallet {
    ...
    */
    derive(path) {
        try {
            ...
            var len0 = WASM_VECTOR_LEN;
            wasm.wallet_derive(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
            ...
            return DerivedAccount.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    */
    get_extended_keys(path) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.wallet_get_extended_keys(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    account(path) {
        try {
            ...
            var ptr0 = passStringToWasm0(path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.wallet_account(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
export function __wbg_getUTCDate_55257fc1fc289fe1(arg0) {
    var ret = getObject(arg0).getUTCDate();
    return ret;
};

export function __wbg_getUTCFullYear_ac803d30c74c4ae5(arg0) {
    var ret = getObject(arg0).getUTCFullYear();
    return ret;
};

export function __wbg_getUTCHours_02c89df88ffb68db(arg0) {
    var ret = getObject(arg0).getUTCHours();
    return ret;
};

export function __wbg_getUTCMinutes_d5bb828e368f7f74(arg0) {
    var ret = getObject(arg0).getUTCMinutes();
    return ret;
};

export function __wbg_getUTCMonth_8b342516cb9b0874(arg0) {
    var ret = getObject(arg0).getUTCMonth();
    return ret;
};

export function __wbg_getUTCSeconds_a27aa033ba9580bd(arg0) {
