...
module.exports.DerivedAccount = DerivedAccount;
/**
*/
class ExtendedKeys {
...
module.exports.ExtendedKeys = ExtendedKeys;
/**
*/
class Keypair {
...
module.exports.WrapperTx = WrapperTx;
...
const path = require('path').join(__dirname, 'anoma_bg.wasm');
